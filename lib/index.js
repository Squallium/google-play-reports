...
// main methods
function appEarnings(urlEarnings, appId) {
    ...
    function onSuccess(res) {
        ...
        // Download the report
        gsutilCp(reportUrl, _reportPath, onError, onFileDownloaded);
    ...
    function onFileDownloaded() {
        ...
        fs.createReadStream(_reportPath + path.basename(reportUrl))
            .pipe(unzip.Extract({path: _reportUnzipPath}))
            .on('close', function () {
